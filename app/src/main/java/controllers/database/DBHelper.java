...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (6,'cus_006','disStore','addre ','area_dalugama','dalugama','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (7,'cus_007','ABD','addre is goes here','area_dalugama','bambalapitiya','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (8,'cus_008','DSI','addre ','area_kiribathgoda','kiribathgoda','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (9,'cus_009','Newkandy','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (10,'cus_010','Newthilakawardhana','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (11,'cus_011','niharika','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (12,'cus_010','Newthilakawardhana','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (13,'cus_010','Newthilakawardhana','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (14,'cus_010','Newthilakawardhana','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (15,'cus_010','Newthilakawardhana','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (16,'cus_010','Newthilakawardhana','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");
        db.execSQL("INSERT INTO Tr_NewCustomer VALUES (17,'cus_010','Newthilakawardhana','addre ','area_kadawatha','kadawatha','071562895','uploaded','pending');");

        //adding data to table 17 ,Mst_Customermaster table
        db.execSQL("INSERT INTO Mst_Customermaster (CustomerNo,CustomerName,Address,Town,Telephone,RouteName)" +
                "VALUES ('CUS1','aksa','Dalugama,Kelaniya','Kelaniya','0715624895','route_name_kadawatha');");
        db.execSQL("INSERT INTO Mst_Customermaster (CustomerNo,CustomerName,Address,Town,Telephone,RouteName)" +
                "VALUES ('CUS2','baraka','No632,DelpeRd,Ragama','Ragama','0715624895','ragama_kadawatha');");
        db.execSQL("INSERT INTO Mst_Customermaster (CustomerNo,CustomerName,Address,Town,Telephone,RouteName)" +
                "VALUES ('CUS3','FoodCity','No632,Dalugama','Dalugama','0715624895','fort_Kiribathgoda');");
        db.execSQL("INSERT INTO Mst_Customermaster (CustomerNo,CustomerName,Address,Town,Telephone,RouteName" +
                "VALUES ('CUS4','foofCity','No562,DelpeRd,Ragama','Ragama','0715624895','ragama_kadawatha');");
        db.execSQL("INSERT INTO Mst_Customermaster (CustomerNo,CustomerName,Address,Town,Telephone,RouteName)" +
                "VALUES ('CUS5','DiscountStore','No632,KandyRd,Dalugama','Dalugama','0715624895','Fort_Kiribathgoda');");
